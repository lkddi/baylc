...
class TotalWxsaleAmounts extends Card
{
    /**
     * 卡片底部内容.
     *
    ...
    {
        $sales = WxSale::whereBetween('created_at', [$start, $end])->company()->sum('amount');
        $sales1 = WxSale::whereBetween('created_at', [$start1, $end1])->company()->sum('amount');
